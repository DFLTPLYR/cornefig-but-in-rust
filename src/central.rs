...
async fn main(spawner: Spawner) {
    ...
    let mut oled = DisplayProcessor::with_renderer(display, CentralLayout::default());

    let keyboard_device_config = DeviceConfig {
        vid: 0x4c4b,
        pid: 0x4643,
        manufacturer: "Corne",
        product_name: "Corne Split Keyboard",
    ...
    join(
        ...
        join(
            run_peripheral_manager::<4, 6, 0, 6, _>(0, &peripheral_addrs, &stack),
